...
public class RolePermissionController 
{
	...
	public ResponseEntity<?> update(@RequestBody RolePermissionRequest rolePermissionRequest)
	{
		try
		{
			...
			return new ResponseEntity<>(new SucessResponseDto("Update Successfully", "Success", rolePermissionRequest),HttpStatus.ACCEPTED);	
		}catch(Exception e)
		{
			return new ResponseEntity<>("Not Found role id or permission id ",HttpStatus.NOT_FOUND);	
		}
	...
	public ResponseEntity<?> delete(@RequestBody RolePermissionRequest rolePermissionRequest)
	{
		try
		{
			...
			return new ResponseEntity<>(new SucessResponseDto("Delete Successfully", "Success", rolePermissionRequest),HttpStatus.ACCEPTED);
